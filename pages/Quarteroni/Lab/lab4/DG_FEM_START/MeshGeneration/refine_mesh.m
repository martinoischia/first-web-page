...
%% [p1,e1,t1,u1] =  refine_mesh(g,p,e,t,u,it,mode)
% PURPOSE:
%
% This routine refines a triangular mesh.
% [p1,e1,t1] = refine_mesh(g,p,e,t) 
%               returns a refined triangular mesh 
%               specified by the geometry g, point matrix p,
%               edge matrix e, and connectivity matrix t.
% Author:
% Paola Antonietti
%--------------------------------------------------------------------
