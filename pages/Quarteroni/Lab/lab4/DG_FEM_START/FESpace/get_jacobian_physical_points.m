...
%% [BJ, BJ_inv, pphys_2D] = get_jacobian_physical_points(loc_coord, nodes_2D)
%  PURPOSE:
%       Compute the Jacobian of the elemental map
%       Compute the inverse of Jacobian of the elemental map
%       Compute the image of the quadrature node on the physical domain
